...
int main(void)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        {
            InputHandler::frontCameraPos = glm::vec3(InputHandler::car_pos_x, InputHandler::car_pos_y + 0.2f, InputHandler::car_pos_z - 0.3f);
            cameraPos = InputHandler::frontCameraPos;
        }
        else
        {
            cameraPos = glm::vec3(InputHandler::car_pos_x, InputHandler::car_pos_y + 0.5f, InputHandler::car_pos_z + 1.5f);
        }
        ...
        renderer.renderModel(shaderProg, VAO, fullVertexData, glm::vec3(InputHandler::car_pos_x, InputHandler::car_pos_y, InputHandler::car_pos_z), glm::vec3(0.1f), glm::vec3(InputHandler::theta_mod_x, InputHandler::theta_mod_y, InputHandler::theta_mod_z), 1.0f);
        renderer.renderModel(shaderProg, VAO, fullVertexData, glm::vec3(-0.5f, -0.5f, 0.0f), glm::vec3(0.1f), glm::vec3(InputHandler::theta_mod_x, InputHandler::theta_mod_y, InputHandler::theta_mod_z), 0.5f);
        renderer.renderModel(shaderProg, VAO, fullVertexData, glm::vec3(0.5f, -0.5f, 0.0f), glm::vec3(0.1f), glm::vec3(InputHandler::theta_mod_x, InputHandler::theta_mod_y, InputHandler::theta_mod_z), 0.5f);
